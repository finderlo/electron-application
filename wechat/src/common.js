...
Common.ELECTRONIC_WECHAT = "wechat";
//这里默认为false
...
Common.GITHUB_ISSUES =
  "https://github.com/geeeeeeeeek/electronic-wechat/issues";
Common.GITHUB_API_HOST = "api.github.com";
Common.GITHUB_API_RELEASE_LATEST_PATH =
  "/repos/geeeeeeeeek/electronic-wechat/releases/latest";

Common.UPDATE_ERROR_ELECTRON =
  "Failed to get the local version. If you are using debug mode(by `npm start`), " +
...
Common.UPDATE_ERROR_NETWORK =
  "Connection hang up unexpectedly. Check your network settings.";
